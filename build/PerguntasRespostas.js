...
function PergEResp() {
    ...
    console.log('1) Armazenam programas e arquivos abertos.');
    console.log('2) Armazenam apenas uma informação.');
    ...
    console.clear();
    // ----------------------------------------------------------
    console.log('A metodologia Ágil tem quantos valores?');
    ...
    console.clear();
    // ----------------------------------------------------------
    console.log('Quantos princípios a metodologia Ágil tem?');
    ...
    console.log('1) CPU, Mouse e Teclado.');
